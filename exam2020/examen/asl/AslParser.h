...
public:
  ...
  class  ForRangeContext : public StatementContext {
  public:
    ForRangeContext(StatementContext *ctx);
  ...
  class  ArrayMaxContext : public ExprContext {
  public:
    ArrayMaxContext(ExprContext *ctx);

    antlr4::Token *op = nullptr;
    ExprContext *expr();
    antlr4::tree::TerminalNode *A_MAX();
  ...
  class  Function_callContext : public ExprContext {
  public:
    Function_callContext(ExprContext *ctx);
  ...
  class  Array_indexContext : public ExprContext {
  public:
    Array_indexContext(ExprContext *ctx);
